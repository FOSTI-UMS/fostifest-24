        ...
        <CardContainer containerClassName="relative justify-center items-center flex lg:w-1/2 md:w-full">
          <CardBody className="relative lg:w-[300px] lg:h-[300px] md:w-[200px] md:h-[200px] w-[180px] h-[180px] overflow-hidden">
            <CardItem className="relative w-full h-full">
              <Image src={ImageConstants.fostifestLogo2} width={300} height={300} alt="Fostifest Overlogic Team" className="absolute inset-0 w-full h-full object-cover rounded-lg z-10 shadow-lg" />
            </CardItem>
          </CardBody>
          <Image
            ...
            width={300}
            height={300}
            alt="Fostifest Overlogic Universe"
