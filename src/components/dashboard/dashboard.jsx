...
const Dashboard = ({ children, activeTab, setActiveTab }) => {
  ...
  return (
    <div className="lg:flex min-h-screen">
      <aside className={`bg-[#0f172a] text-white w-64 p-4 m-2 rounded-xl fixed inset-y-0 left-0 transform ${isSidebarOpen ? "translate-x-0" : "-translate-x-96"} transition-transform duration-300 z-30 lg:relative lg:translate-x-0 lg:w-72`}>
