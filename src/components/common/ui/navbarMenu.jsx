...
export const HoveredLink = ({ children, ...rest }) => {
  return (
    <Link
      {...rest}
      className={cn("relative dark:text-neutral-50 items-center flex space-x-1 text-neutral-600 transition-all duration-300 dark:hover:text-main-primary hover:text-main-primary")}
    >
      {children}
    </Link>
  );
