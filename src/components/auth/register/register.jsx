    ...
    return (
      ...
      <div className="relative w-full md:w-1/2 bg-black flex flex-col justify-center items-center p-8">
          ...
          <div className="w-full max-w-sm mt-32"> 
              ...
              <h3 className="text-white text-3xl font-bold mb-6">Create an Account</h3>
              ...
              <form className="w-full">
                  <div className="relative mb-6">
                      ...
                      />
                      <label className="absolute top-3 left-3 transform -translate-y-1/2 bg-none px-1 text-black text-sm fon">Full Name</label>
                  </div>
                  <div className="relative mb-6">
                      <input
                          className="w-full p-3 border-b-2 border-black rounded-md bg-white text-black focus:outline-none pl-3 pt-6"
                  ...
                  <div className="relative mb-6">
                      ...
                      <label className="absolute top-3 left-3 transform -translate-y-1/2 bg-none px-1 text-black text-sm">Category</label>
                  </div>
