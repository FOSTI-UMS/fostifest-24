        ...
        <div className="w-full lg:max-w-md sm:max-w-sm md:max-w-lg lg:mt-20 sm:mt-28 md:mt-10">
          ...
          <form className="w-full" onSubmit={handleSubmit}>
            <div className={`relative mb-6`}>
              ...
              <label className="font-medium absolute top-4 left-2 transform -translate-y-1/2 bg-none px-1 text-black text-sm">Kategori</label>
            ...
            <div className={`relative ${errors.fullName ? "mb-0" : "mb-6"}`}>
              ...
              />
              <label className="font-medium absolute top-4 left-2 transform -translate-y-1/2 bg-none px-1 text-black text-sm">{selectedCategory === "CompetitionCategoriesConstant.sd" ? "Nama Ketua" : "Nama Lengkap"}</label>
            ...
            {selectedCategory === CompetitionCategoriesConstant.sd && (
              <>
                <div className={`relative mb-6`}>
                  <input
                    className={`text-sm w-full p-3 border-2 ${errors.member1 ? "border-red-500" : "border-black"} hover:border-main-primary focus:border-main-primary rounded-lg bg-white text-black focus:outline-none pl-3 pt-6`}
                    id="member1"
                    type="text"
                    ...
                    onChange={handleChange}
                  />
                  <label className="font-medium absolute top-4 left-2 transform -translate-y-1/2 bg-none px-1 text-black text-sm">Nama Anggota 1 (opsional)</label>
                  {errors.member1 && <p className="text-red-500 text-xs mt-1 mb-6">{errors.member1}</p>}
                </div>
                <div className={`relative mb-6`}>
                  <input
                    ...
                    onChange={handleChange}
                  />
                  <label className="font-medium absolute top-4 left-2 transform -translate-y-1/2 bg-none px-1 text-black text-sm">Nama Anggota 2 (opsional)</label>
                  {errors.member2 && <p className="text-red-500 text-xs mt-1 mb-6">{errors.member2}</p>}
                </div>
              </>
            )}
            ...
            <div className={`relative ${errors.phoneNumber ? "mb-0" : "mb-6"}`}>
              <input
                ...
                onChange={handleChange}
              />
              <label className="font-medium absolute top-4 left-2 transform -translate-y-1/2 bg-none px-1 text-black text-sm">{selectedCategory === "CompetitionCategoriesConstant.sd" ? "Nomor Telepon Ketua" : "Nomor Telepon"}</label>
            ...
            <div className={`relative ${errors.email ? "mb-0" : "mb-6"}`}>
              <input
                ...
                onChange={handleChange}
              />
              <label className="font-medium absolute top-4 left-2 transform -translate-y-1/2 bg-none px-1 text-black text-sm">{selectedCategory === "CompetitionCategoriesConstant.sd" ? "Email Ketua" : "Email"}</label>
            ...
            <div className={`relative ${errors.password ? "mb-0" : "mb-6"}`}>
              ...
              <button type="button" className="absolute right-2 top-1/2 transform -translate-y-1/2 text-sm text-main-primary" onClick={togglePasswordVisibility}>
                {passwordVisible ? <Image height={28} src={IconConstants.visiblePass} alt="visible-pass-register-competition" /> : <Image height={28} src={IconConstants.invisiblePass} alt="invisible-pass-register-competition" />}
              </button>
            </div>
